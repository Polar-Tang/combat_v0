...
local get_hit_sound = require("get_hit_sound")
return function(newHitbox, getStrength, serviceBag)
	local WeaponBinder = serviceBag:GetService(require("Weapon"))
	...
	return function(hit, enemyHum)
		...
		--local STRENGTH = 10
		local data = getStrength(enemyHum)
